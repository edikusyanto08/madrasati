          ...
          <div class="row">
            ...
            <div class="widget w-create-fav-page">
              ...
              <div class="content">
                ...
                <a href="<?php echo base_url();?>parents/subject/" class="btn btn-warning btn-sm"><?php echo get_phrase('go_to_academic');?></a>
              </div>
            </div>
          </div>
                        <div class="ui-block paddingtel" >
                      ...
                      <div class="item <?php if($var1 == 1) echo "active";?>">
                        <div class="widget w-birthday-alert">
                          ...
                          <div class="content">
                            ...
                            <a href="<?php echo base_url();?>parents/birthdays/" class="text-white"><p><?php echo get_phrase('view_all_birthdays');?></p></a>
                          </div>
                        </div>
                      </div>
                    <?php endforeach;?>

...
?>
<?php $query = $this->db->get_where('deliveries', array('homework_code' => $homework_code, 'student_id' => $student_id));?>
<div class="content-w">
     <div class="conty">
		...
		<div class="pipeline white lined-secondary">
		  ...
		  <table class="table table-lightbor table-lightfont">
			  ...
			  <tr>
				...
				<?php endif;?>
				<?php if($query->num_rows() > 0):?>
				  <a class="btn btn-rounded btn-sm btn-primary" style="color:white"><?php $mark =$this->db->get_where('deliveries', array('homework_code' => $homework_code, 'student_id' => $student_id))->row()->mark; if($mark > 0) echo $mark; else echo get_phrase('waiting_mark');?></a>
				<?php endif;?>
				</td>
			  </tr>
			   <tr>

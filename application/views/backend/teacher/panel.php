              ...
              <?php if($wall['type'] == 'news'):?>
                <div class="ui-block paddingtel">
                  ...
                  <article class="hentry post has-post-thumbnail thumb-full-width">
                    ...
                    <?php $file = base_url('uploads/news_images/'.$news_code.'.jpg');?>
                              ...
                              <div class="skills-item-info">
                                <span class="skills-item-title">
                                  <span class="radio">
                                    <h6>
                                      <label>
                                        <input type="radio" id="answer" name="answer<?php echo $poll_code;?>" value="<?php echo $array[$i];?>">
                                        ...
                                        <div class="skills-item-info">
                                          <span class="skills-item-title">
                                            <?php
                                              ...
                                              ?>
                                            <h6>
                                              <label><?php echo $array[$i];?></label></h6>
                                          </span>
                                          <?php
                                            $response = $res/$polls;
                              ...
                              <div class="sidebar__inner">
                                <div class="ui-block paddingtel">
                                  <div class="today-events calendar ">
                                    ...
                                    <div class="list">
                                      <?php $date = date('Y-m-d')." "."00:00:00"; $events = $this->db->get_where('events', array('start' => $date)); ?>
                                      <div id="accordion-1" role="tablist" aria-multiselectable="true" class="day-event" data-month="12" data-day="2">
                                        <?php if($events->num_rows() > 0):?><?php foreach($events->result_array() as $event):?>
                                        <div class="card">
                                          <div class="card-header" role="tab" id="headingOne-1">
                                            <div class="event-time">
                                              <h5 class="mb-0 title">
                                                <a href="<?php echo base_url();?>teacher/calendar/"><?php echo $event['title'];?></a>
                                              </h5>
                                            </div>
                                          </div>
                                        </div>

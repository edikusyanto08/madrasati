            ...
            <main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
                ...
                ?>
                  ...
                  <?php if($wall['type'] == 'polls'):?>
                    ...
                    ?>
                    <?php if($usrdb == 'accountant' || $usrdb == 'all'):?>
                      <?php
                        $type = 'accountant';
            ...
            <div class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-12 col-12">
                <div class="crumina-sticky-sidebar">
				    ...
				    <div class="widget w-create-fav-page">
					    ...
					    <div class="content">
						    <h3 class="title"><?php echo get_phrase('welcome_accountant_dashboard');?></h3>
						    <a href="<?php echo base_url();?>accountant/payments/" class="btn btn-warning btn-sm"><?php echo get_phrase('go_to_payments');?></a>
					    </div>
				    </div>
			    </div>
                        <div class="ui-block paddingtel" >
                      ...
                      <div class="item <?php if($var1 == 1) echo "active";?>">
                        <div class="widget w-birthday-alert">
                          ...
                          <div class="content">
                            ...
                            <a href="<?php echo base_url();?>accountant/birthdays/" class="text-white"><p><?php echo get_phrase('view_all_birthdays');?></p></a>
                          </div>
                        </div>
                      </div>
                    <?php endforeach;?>

                      ...
                      <?php $bus = $this->db->get('transport')->result_array();
				        ...
				        <tr>
					        ...
					        <td>
						        ...
						        <a style="color:grey;" onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" class="danger" href="<?php echo base_url();?>admin/school_bus/delete/<?php echo $buss['transport_id'];?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
					        </td>
				        </tr>
				        <?php endforeach;?>
                      </tbody>

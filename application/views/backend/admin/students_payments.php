  ...
  <div class="content-i">
	...
	<div class="element-wrapper">
		...
		<div class="tab-pane active" id="invoices">
		    <a class="btn btn-rounded btn-success text-white" href="<?php echo base_url();?>admin/new_payment/"><?php echo get_phrase('new_payment');?></a><br><br>
		    <div class="element-wrapper">

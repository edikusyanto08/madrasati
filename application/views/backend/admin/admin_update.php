                    								...
                    								<div class="form-group label-floating is-select">
                        								...
                        								<div class="select">
                            								<select name="owner_status">
                                								...
                                								<option value="1" <?php if($row['owner_status'] == 1) echo "selected";?>><?php echo get_phrase('super_admin');?></option>
                                								<option value="0" <?php if($row['owner_status'] == 0) echo "selected";?>><?php echo get_phrase('admin');?></option>
                            								</select>
                        								</div>
                    								</div>
                								</div>
                						...
                						<div class="help-support-block">
											...
											<ul class="help-support-list">
												<li>
													...
													<a href="<?php echo base_url();?>admin/admin_profile/<?php echo $admin_id;?>/"><?php echo get_phrase('personal_information');?></a>
												</li>
												<li>
													<i class="picons-thin-icon-thin-0133_arrow_right_next" style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
													<a href="<?php echo base_url();?>admin/admin_update/<?php echo $admin_id;?>/"><?php echo get_phrase('update_information');?></a>
												</li>
											</ul>
										</div>
									</div>

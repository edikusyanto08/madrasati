                                                                 ...
                                                                 <div class="col-sm-12">
                                                                           <div class="row">
                                                                                <?php
                                                                                     ...
                                                                                     if ($i == 2) {$m = get_phrase('february'); $ma = 02;}
                                                                                     if ($i == 3) {$m = get_phrase('march'); $ma = 03;}
                                                                                     if ($i == 4) {$m = get_phrase('april'); $ma = 04;}
                                                                                     if ($i == 5) {$m = get_phrase('may'); $ma = 05;}
                                                                                     if ($i == 6) {$m = get_phrase('june'); $ma = 06;}
                                                                                     if ($i == 7) {$m = get_phrase('july'); $ma = 07;}

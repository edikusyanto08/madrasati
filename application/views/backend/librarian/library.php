    ...
    <div class="conty">
					...
					<div class="friend-item-content">
						<div class="friend-avatar">
							...
							<div class="author-content">
								<div class="country"><b> <?php echo get_phrase('total_books');?></b></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="friend-item friend-groups">
					<div class="friend-item-content">
						<div class="friend-avatar">
							...
							<div class="author-content">
								<div class="country"><b><?php echo get_phrase('total_copies');?></b></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="friend-item friend-groups">
					<div class="friend-item-content">
						<div class="friend-avatar">
							...
							<div class="author-content">
								<div class="country"><b> <?php echo get_phrase('delivered_copies');?></b></div>
							</div>
						</div>
					</div>
				</div>
        ...
        <?php endif;?>
				...
				<td class="row-actions">
					...
					<a class="danger" onClick="return confirm('<?php echo get_phrase('confirm_delete');?>')" href="<?php echo base_url();?>librarian/library/delete/<?php echo $row['book_id'];?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
				</td>
			</tr>
			<?php endforeach;?>
                      </tbody>

            ...
            <div class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-12 col-12">
                <div class="crumina-sticky-sidebar">
                        ...
                        <div class="ui-block paddingtel">
                            <div class="ui-block-content">
                                <div class="widget w-about">
                                    <a href="javascript:void(0);" class="logo"><img src="<?php echo base_url();?>uploads/logo.png" title="<?php echo $this->db->get_where('settings', array('type' => 'system_name'))->row()->description;?>"></a>
                                    <ul class="socials">
				    ...
				    <div class="widget w-create-fav-page">
					    ...
					    <div class="content">
						    <h3 class="title"><?php echo get_phrase('welcome_librarian_dashboard');?></h3>
						    <a href="<?php echo base_url();?>librarian/library/" class="btn btn-warning btn-sm"><?php echo get_phrase('go_to_library');?></a>
					    </div>
				    </div>
			    </div>
                        <div class="ui-block paddingtel" >
                      ...
                      <div class="item <?php if($var1 == 1) echo "active";?>">
                        <div class="widget w-birthday-alert">
                          ...
                          <div class="content">
                            ...
                            <a href="<?php echo base_url();?>librarian/birthdays/" class="text-white"><p><?php echo get_phrase('view_all_birthdays');?></p></a>
                          </div>
                        </div>
                      </div>
                    <?php endforeach;?>
